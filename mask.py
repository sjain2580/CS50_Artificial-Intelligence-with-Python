...
def get_color_for_attention_score(attention_score):
    ...
    # Map score to grayscale (0=black, 1=white)
    gray = int(score * 255)
...
def visualize_attentions(tokens, attentions):
    ...
    for layer in range(num_layers):
        num_heads = len(attentions[layer][0])
        for head in range(num_heads):
            layer_number = layer + 1
            head_number = head + 1
            attention_weights = attentions[layer][0][head]
            ...
            print(f"Generated diagram for Layer {layer_number}, Head {head_number}")
